        ...
        function updateLanguage() {
            ...
            //document.querySelectorAll('.stat-label')[0].textContent = texts.yearsExp;
            //document.querySelectorAll('.stat-label')[1].textContent = texts.projectsCompleted;
            ...
            document.querySelectorAll('.footer-text p')[1].textContent = texts.footerMade;
